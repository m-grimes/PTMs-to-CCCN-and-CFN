...
sp.filepath = "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ShortestPathsAnalysis/"
...
```
#This chunk calculates selects drug affected sites for the four sample groups for which we want to constuct shortest paths networks. We will calculate the median value (ratio of drug treated to untreated) for each site in a group that has at least two observations; then we will select the sites where the median is at least 2.25-fold up or down.
