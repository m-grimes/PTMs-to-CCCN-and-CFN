...
sample_counting <- data.frame(edge_l,node_l,sample_order_l,total_edge_l,totoal_node_l)
...
# PC9_SEPTM_Erlotinib_EGFR_2
graph.cfn.cccn (up_paths_11, ld=FALSE, gz=TRUE, only.cfn=TRUE)
all.ratio.styles()
