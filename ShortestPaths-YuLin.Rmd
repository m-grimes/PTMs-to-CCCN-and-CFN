...
ratio_df <- as.matrix(ratio_df)
ratio_df <- t(ratio_df)
write.table(ratio_df, "ratio_df.txt")

ratio_dataframe <- read.csv("ratio_df.csv",header = FALSE)
sample_15 <- c("ss1",
"ss2",
"ss3",
"ss4",
...
"ss16",
"ss25")
colnames(ratio_dataframe) <- sample_15
rownames(ratio_dataframe) <- sample_15
pheatmap::pheatmap(ratio_dataframe)
