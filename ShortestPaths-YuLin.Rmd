...
# H3122_ALK_MET_SEPTM 
# ALK MET
ALK_MET_ex_MYH9_paths_1 <- shortest.paths.to.target(ss1,target = c("ALK","MET"),excluded_gene = "MYH9") #498 nodes/ 454 nodes in ex
ALK_MET_ex_MYH9_paths_2 <- shortest.paths.to.target(ss2,target = c("ALK","MET")) #475 nodes
ALK_MET_ex_MYH9_paths_3 <- shortest.paths.to.target(ss3,target = c("ALK","MET")) #485 nodes

# ALK MET EGFR
ALK_MET_EGFR_ex_MYH9_paths_1 <- shortest.paths.to.target(ss1,target = c("ALK","MET","EGFR")) #526 nodes
ALK_MET_EGFR_ex_MYH9_paths_2 <- shortest.paths.to.target(ss2,target = c("ALK","MET","EGFR")) #497 nodes
ALK_MET_EGFR_ex_MYH9_paths_3 <- shortest.paths.to.target(ss3,target = c("ALK","MET","EGFR")) #507 nodes


# ex_MYH9_H3122_ALK_MET_SEPTM_all <- my.intersect(ALK_MET_ex_MYH9_paths_1,ALK_MET_ex_MYH9_paths_2,ALK_MET_ex_MYH9_paths_3)
# ex_MYH9_H3122_ALK_MET_SEPTM_all_CFN <- graph.cfn.cccn (ex_MYH9_H3122_ALK_MET_SEPTM_all, ld=FALSE, gz=TRUE, only.cfn=TRUE)
# setCorrEdgeAppearance(ex_MYH9_H3122_ALK_MET_SEPTM_all_CFN)
# FixEdgeDprops.RCy32()
# all.ratio.styles()
graph.cfn.cccn (o_inter, ld=FALSE, gz=TRUE, only.cfn=TRUE)


o1<- my.outersect(ALK_MET_ex_MYH9_paths_1,ALK_MET_ex_MYH9_paths_2)
o2 <- my.outersect(ALK_MET_ex_MYH9_paths_1,ALK_MET_ex_MYH9_paths_3)
o_inter <- my.intersect(o1,o2)

# g1 <- graph.cfn.cccn (o_inter, ld=FALSE, gz=TRUE, only.cfn=TRUE)
# setCorrEdgeAppearance(g1)
FixEdgeDprops.RCy32()
# all.ratio.styles()

genes_counts(o_inter)
