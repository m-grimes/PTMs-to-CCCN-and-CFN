...
graph.cfn.cccn (ex_MYH9_MET_H3122_ALK_SEPTM, ld=FALSE, gz=TRUE, only.cfn=TRUE)
all.ratio.styles()
graph.cfn.cccn (ex_MYH9_MET_H3122_ALK_SEPTM, ld=FALSE, gz=TRUE, only.cfn=FALSE)
all.ratio.styles()

exclusion <- my.intersect(ex_MYH9_MET_H3122_ALK_SEPTM,ex_H3122_ALK_SEPTM)
graph.cfn.cccn (exclusion, ld=FALSE, gz=TRUE, only.cfn=TRUE)
all.ratio.styles()
graph.cfn.cccn (exclusion, ld=FALSE, gz=TRUE, only.cfn=FALSE)
all.ratio.styles()
...
```{r}
TNS3_ALK_path <- composite.shortest.paths("TNS3","ALK",gzalltgene.physical.cfn.merged,exclude = "MYH9")
PKM_ALK_path <- composite.shortest.paths("PKM","ALK",gzalltgene.physical.cfn.merged,exclude = "MYH9")

graph.cfn.cccn (TNS3_ALK_path, ld=FALSE, gz=TRUE, only.cfn=FALSE)
all.ratio.styles()


gz.cf[which(gz.cf$Gene.Name == "PKM"),c("id","Gene.Name","H3122SEPTM.C1.ratio","H3122SEPTM.C2.ratio","H3122SEPTM.C3.ratio")]
