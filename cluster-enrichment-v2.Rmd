...
group_meds_all$id <- gz.cf.good.col.names.all.na$id
group_meds_all$Gene.Name <- gz.cf.good.col.names.all.na$Gene.Name
group_meds_all$Node.ID <- gz.cf.good.col.names.all.na$Node.ID
