...
sig.site.meds.filepath = "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ClusterEnrichment-v4/SigSitesMeds/"

results_table_file_path = "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ClusterEnrichment-v4/"

heatmap_path_130.141.111 <- "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ClusterEnrichment-v4/heatmaps-130.141.111/"

heatmap_path_180.173.39 <- "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ClusterEnrichment-v4/heatmaps-180.173.39/"

heatmap_path_38.41.40 <- "/Users/karenross/Documents/Bioinformatics/PIR/GrimesGroupCollab/ClusterEnrichment-v4/heatmaps-38.41.40/"
...
write.table(enrich.table, file = paste(results_table_file_path, "enrichment_results_meds_05_v2.txt", sep=""), sep = "\t", row.names = FALSE, quote = FALSE)
...
#Calculate the median of each site for the experiments in each group; only calculate the median if there are at least two reps in #the set; otherwise return NA; change the NA's to 0's for plotting node colors and sizes in Cytoscape;add the non-ratio columns #from gz.cf.good.col.names.all.na to the median table
...
group_meds_all[which(test$id == "KAT7"), "nodeType"] <- "acetyltransferase"
...
all.ratio.styles(ratiocols = names(good_experiments))
